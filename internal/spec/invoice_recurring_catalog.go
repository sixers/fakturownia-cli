...
func invoiceCreateRequestBodySpec() *RequestBodySpec {
	return &RequestBodySpec{
		...
		Notes: []string{
			...
			"companion CLI flags `--identify-oss`, `--fill-default-descriptions`, and `--correction-positions` are applied outside the inner invoice object",
...
func invoiceRequestFields() []RequestFieldSpec {
	return []RequestFieldSpec{
		...
		{Path: "recipients[].role", Type: "string", Description: "Recipient role", SourceSection: "Odbiorcy/Wystawcy na fakturze"},
