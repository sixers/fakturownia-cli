...
func invoiceRequestFields() []RequestFieldSpec {
	return []RequestFieldSpec{
		...
		{Path: "seller_email", Type: "string", Description: "Seller email address", SourceSection: "Dodanie nowej faktury"},
		{Path: "seller_phone", Type: "string", Description: "Seller phone number", SourceSection: "Dodanie nowej faktury"},
		{Path: "seller_fax", Type: "string", Description: "Seller fax number", SourceSection: "Dodanie nowej faktury"},
		{Path: "seller_www", Type: "string", Description: "Seller website", SourceSection: "Dodanie nowej faktury"},
		{Path: "seller_bdo_no", Type: "string", Description: "Seller BDO number", SourceSection: "Dodanie nowej faktury"},
		{Path: "use_invoice_issuer", Type: "string", Description: "Use alternate invoice issuer data", SourceSection: "Dodanie nowej faktury", EnumValues: []string{"1", "0"}},
		{Path: "invoice_issuer", Type: "string", Description: "Invoice issuer label or description", SourceSection: "Dodanie nowej faktury"},
		...
		{Path: "buyer_note", Type: "string", Description: "Additional buyer description", SourceSection: "Dodanie nowej faktury"},
		{Path: "buyer_phone", Type: "string", Description: "Buyer phone number", SourceSection: "Korekty faktur"},
		{Path: "buyer_mobile_phone", Type: "string", Description: "Buyer mobile phone number", SourceSection: "Korekty faktur"},
		...
		{Path: "use_delivery_address", Type: "string", Description: "Use an alternate delivery address", SourceSection: "Pola klienta", EnumValues: []string{"1", "0"}},
		{Path: "delivery_address", Type: "string", Description: "Alternate delivery address", SourceSection: "Pola klienta"},
		...
		{Path: "np_tax_kind", Type: "string", Description: "Reason code for non-taxable positions", SourceSection: "Zmiany w API przy tworzeniu faktur", EnumValues: []string{"export_service", "export_service_eu", "not_specified"}},
