	...
	return []CommandSpec{
		...
		},
		{
			...
			Examples: []string{
				...
				"fakturownia bank-account get --id 100 --fields id,bank_name,bank_account --json",
		...
		},
		{
			...
			Examples: []string{
				`fakturownia bank-account create --input '{"bank":"Bank of China","bank_account":"11 1111 1111 1111 1111 1111 1111","bank_account_currency":"PLN","default":true}' --json`,
				`fakturownia bank-account create --input '{"bank":"Bank of China","bank_account_version_departments":[{"department_id":5,"main_on_department":true,"show_on_invoice":true}]}' --json`,
				"fakturownia bank-account create --input @bank-account.json",
				`fakturownia bank-account create --input '{"bank":"Bank of China"}' --dry-run --json`,
			},
			EnvVars:      env,
			OutputModes:  []string{"human", "json"},
			ExitCodes:    exitCodes,
