...
- Added explicit bootstrap guidance to the root bundle and shared skill so agents install `fakturownia`, authenticate with `auth login`, and verify access before making API calls.
